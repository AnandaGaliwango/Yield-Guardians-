...
file_path = "GygaUganda - Station.csv"  # or "GygaUganda.csv" depending on which file you have
# Load the Excel file
...
# Example usage:
file_path = "GygaUganda - Station.csv"
target_column = 'YA'
...
# Add this to check current directory and list files
import os
